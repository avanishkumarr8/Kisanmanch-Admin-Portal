...
import { getAllRejectedOrders } from '../../Services/OrderSevices';
const { Option } = Select;
...
const Rejected = props => {
  ...
  const fetchData = async () => {
    try {
      ...
      const allRejectedOrder = await getAllRejectedOrders()
      console.log(allRejectedOrder)
      if (allRejectedOrder) {
        setData(allRejectedOrder);
        SetSpin(true)
      }
    } catch (e) {
      console.log(e)
  ...
  return (
    ...
    <div style={{ background: 'white', paddingLeft: "20px", width: "98.5%", marginLeft: "14px", marginTop: "20px", marginBottom: "10px" }}>
      <Divider orientation="left" style={{ paddingLeft: "10px", paddingTop: 10 }}>Rejected List</Divider>
      {spin
